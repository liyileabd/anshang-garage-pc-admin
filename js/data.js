    ...
    // 业务台账：资金流水。一行 = 一笔资金动作（收款 / 分账 / 退款）
    // 字段：[发生时间, 业务订单号, 小区项目, 资金动作, 去向账户(字符串=单一账户；数组=分账明细), 金额, 状态]
    const ledgerEntries = [
      ['2026-09-13 15:22','AS202608280016','荣和家园','分账','—（项目未配置收款主体）','-1,200.00','分账异常'],
      ...
      ['2026-08-29 02:00','AS202608280018','锦绣安置房','分账',[['安商房运营公司','1,460.87'],['锦绣物业服务','219.13']],'-1,680.00','已到账'],
      ['2026-08-29 02:00','AS202608280017','文庭商房','分账',[['区财政非税收入专户','960.00']],'-960.00','分账处理中'],
      ['2026-08-29 02:00','AS202608280015','锦绣安置房','分账',[['安商房运营公司','2,086.96'],['锦绣物业服务','313.04']],'-2,400.00','已到账'],
      ['2026-08-29 02:00','AS202608280013','文庭商房','分账',[['区财政非税收入专户','960.00']],'-960.00','已到账'],
      ...
      ['2026-08-28 02:00','AS202608270012','锦绣安置房','分账',[['安商房运营公司','834.78'],['锦绣物业服务','125.22']],'-960.00','已到账'],
      ['2026-08-27 14:20','AS202608270012','锦绣安置房','收款','结算平台 · 待分资金','+960.00','已入账'],
      ['2026-08-27 02:00','AS202608260010','文庭商房','分账',[['区财政非税收入专户','1,080.00']],'-1,080.00','已到账'],
      ...
      ['2026-08-12 02:00','AS202608120009','荣和家园','分账','—（项目未配置收款主体）','-860.00','分账异常'],
      ['2025-07-19 02:00','AS202507180021','锦绣安置房','分账',[['安商房运营公司','1,043.48'],['锦绣物业服务','156.52']],'-1,200.00','已到账'],
