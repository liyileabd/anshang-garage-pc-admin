    ...
    function showModal(title, body) {
      ...
      document.querySelector('#modalMask .modal')?.classList.remove('refund-approval-modal', 'refund-application-modal', 'project-status-modal', 'project-stop-modal', 'renew-order-modal', 'invoice-application-modal', 'refund-export-modal', 'invoice-export-modal', 'invoice-preview-modal');
      const cancelButton = document.getElementById('modalCancelButton');
      const confirmButton = document.getElementById('modalConfirmButton');
